...
**Ruby / Rails** **React** **NodeJS** **KnexJS** **Jest** **React Testing Library** _Enzyme_ **MySQL**  _VueJS_ _Redux_ _redux-thunk_ **PostgreSQL** _Wordpress_ **Gatsby** **Sass** _Angular_ **ExpressJS** _SQLite_ **NodeJS** _TypeORM_ _Sequelize_ **Shopify App Development** **NextJS** _PHP_ **jQuery** <del>ASP Classic</del> </del>MSAccess</del> _CodeIgniter_ _NestJS_
